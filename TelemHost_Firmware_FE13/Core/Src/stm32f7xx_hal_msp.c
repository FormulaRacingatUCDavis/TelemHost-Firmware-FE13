...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* hcan)
{
  if(hcan->Instance==CAN1)
  {
    ...
    PA12     ------> CAN1_TX
    */
    HAL_GPIO_DeInit(GPIOA, TCAN_RX_Pin|TCAN_TX_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM9)
  {
    ...
    PE5     ------> TIM9_CH1
    */
    GPIO_InitStruct.Pin = LAT_LON_INT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM9;
    HAL_GPIO_Init(LAT_LON_INT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART2)
  {
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, XSENS_UART_TX_Pin|XSENS_UART_RX_Pin);
  ...
  else if(huart->Instance==USART3)
  {
    ...
    PD9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOD, USB_UART_TX_Pin|USB_UART_RX_Pin);
